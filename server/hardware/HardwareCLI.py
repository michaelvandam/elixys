...
if __name__ == "__main__":
    ...
    while True:
        ...
        if sCommand == "exit":
            ...
            print "  list functions  Lists the function names"
            print "  list names      List the hardware names"
            print "  list positions  List the position names"
            ...
            print "  Valve functions:"
            print "    OpenValve(sName)"
            print "    CloseValve(sName)"
            ...
            print "    PressureRegulatorOn(sName)"
            print "    PressureRegulatorOff(sName)"
            print "    SetPressureRegulatorPressure(sName, fPressure)"
            print "  Reagent robot functions:"
            print "    MoveReagentRobotToPosition(sPositionName)"
            print "    GripperUp()"
            print "    GripperDown()"
            print "    GripperOpen()"
            print "    GripperClose()"
            print "  Reactor functions:"
            print "    MoveReactorToPosition(sPositionName)"
            print "    ReactorUp(sName)"
            print "    ReactorDown(sName)"
            print "  Temperature controller functions:"
            print "    HeaterOn(sName)"
            print "    HeaterOff(sName)"
            print "    SetHeaterSetPoint(sName, fSetPoint)"
            print "  Stir motor functions:"
            print "    SetMotorSpeed(sName, nMotorSpeed)"
            print "  Radiation detector functions:"
            print "    ReadRadiationDetector(sName)"
            ...
            print "  Valve names:"
            print "    [reactor]_EvaporationValve"
            print "    [reactor]_VacuumValve"
            print "    [reactor]_TransferValve"
            print "    [reactor]_Reagent1TransferValve"
            print "    [reactor]_Reagent2TransferValve"
            print "    [reactor]_Stopcock1Valve"
            print "    [reactor]_Stopcock2Valve"
            print "    [reactor]_Stopcock3Valve"
