...
(
    ...
    ReagentRobotErrorX INT UNSIGNED,
    ReagentRobotErrorY INT UNSIGNED,
    ...
    Reactor1RobotError INT UNSIGNED,
    ...
    Reactor2RobotError INT UNSIGNED,
    ...
    Reactor3RobotError INT UNSIGNED,
