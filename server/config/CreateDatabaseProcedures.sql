...
CREATE PROCEDURE StatusLog(IN iVacuumSystemOn BOOL, IN iVacuumSystemPressure FLOAT, IN iCoolingSystemOn BOOL, IN iPressureRegulator1SetPressure FLOAT,
      ...
      IN iReagentRobotStatusY VARCHAR(64), IN iReagentRobotControlX INT UNSIGNED, IN iReagentRobotControlY INT UNSIGNED, IN iReagentRobotCheckX INT UNSIGNED,
      IN iReagentRobotCheckY INT UNSIGNED, IN iGripperSetUp BOOL, IN iGripperSetDown BOOL, IN iGripperSetOpen BOOL, IN iGripperSetClose BOOL, IN iGasTransferSetUp BOOL,
      IN iGasTransferSetDown BOOL, IN iGripperUp BOOL, IN iGripperDown BOOL, IN iGripperOpen BOOL, IN iGripperClose BOOL, IN iGasTransferUp BOOL, IN iGasTransferDown BOOL,
      IN iReactor1SetPosition VARCHAR(30), IN iReactor1ActualPosition VARCHAR(30), IN iReactor1SetY INT, IN iReactor1ActualY INT, IN iReactor1RobotStatus VARCHAR(30),
      IN iReactor1RobotControl INT UNSIGNED, IN iReactor1RobotCheck INT UNSIGNED, IN iReactor1SetUp BOOL, IN iReactor1SetDown BOOL, IN iReactor1Up BOOL, IN iReactor1Down BOOL,
      IN iReactor1Stopcock1Position VARCHAR(4), IN iReactor1Stopcock2Position VARCHAR(4), IN iReactor1Stopcock3Position VARCHAR(4), IN iReactor1Collet1On BOOL,
      IN iReactor1Collet1SetTemperature FLOAT, IN iReactor1Collet1ActualTemperature FLOAT, IN iReactor1Collet2On BOOL, IN iReactor1Collet2SetTemperature FLOAT,
      IN iReactor1Collet2ActualTemperature FLOAT, IN iReactor1Collet3On BOOL, IN iReactor1Collet3SetTemperature FLOAT, IN iReactor1Collet3ActualTemperature FLOAT,
      IN iReactor1StirMotor INT UNSIGNED, IN iReactor1RaditationDetector FLOAT, IN iReactor2SetPosition VARCHAR(30), IN iReactor2ActualPosition VARCHAR(30), IN iReactor2SetY INT,
      IN iReactor2ActualY INT, IN iReactor2RobotStatus VARCHAR(30), IN iReactor2RobotControl INT UNSIGNED, IN iReactor2RobotCheck INT UNSIGNED, IN iReactor2SetUp BOOL,
      IN iReactor2SetDown BOOL, IN iReactor2Up BOOL, IN iReactor2Down BOOL, IN iReactor2Stopcock1Position VARCHAR(4), IN iReactor2Collet1On BOOL,
      ...
      IN iReactor3ActualY INT, IN iReactor3RobotStatus VARCHAR(30), IN iReactor3RobotControl INT UNSIGNED, IN iReactor3RobotCheck INT UNSIGNED, IN iReactor3SetUp BOOL,
      IN iReactor3SetDown BOOL, IN iReactor3Up BOOL, IN iReactor3Down BOOL, IN iReactor3Stopcock1Position VARCHAR(4), IN iReactor3Collet1On BOOL,
    ...
    BEGIN
        ...
        INSERT INTO StatusLog VALUES (NULL, NULL, iVacuumSystemOn, iVacuumSystemPressure, iCoolingSystemOn, iPressureRegulator1SetPressure, iPressureRegulator1ActualPressure,
            ...
            iReagentRobotStatusY, iReagentRobotControlX, iReagentRobotControlY, iReagentRobotCheckX, iReagentRobotCheckY, iGripperSetUp, iGripperSetDown, iGripperSetOpen,
            iGripperSetClose, iGasTransferSetUp, iGasTransferSetDown, iGripperUp, iGripperDown, iGripperOpen, iGripperClose, iGasTransferUp, iGasTransferDown,iReactor1SetPosition,
            iReactor1ActualPosition, iReactor1SetY, iReactor1ActualY, iReactor1RobotStatus, iReactor1RobotControl, iReactor1RobotCheck, iReactor1SetUp, iReactor1SetDown,
            iReactor1Up, iReactor1Down, iReactor1Stopcock1Position, iReactor1Stopcock2Position, iReactor1Stopcock3Position, iReactor1Collet1On, iReactor1Collet1SetTemperature,
            iReactor1Collet1ActualTemperature, iReactor1Collet2On, iReactor1Collet2SetTemperature, iReactor1Collet2ActualTemperature, iReactor1Collet3On,
            iReactor1Collet3SetTemperature, iReactor1Collet3ActualTemperature, iReactor1StirMotor, iReactor1RaditationDetector, iReactor2SetPosition, iReactor2ActualPosition,
            iReactor2SetY, iReactor2ActualY, iReactor2RobotStatus, iReactor2RobotControl, iReactor2RobotCheck, iReactor2SetUp, iReactor2SetDown, iReactor2Up, iReactor2Down,
            iReactor2Stopcock1Position, iReactor2Collet1On, iReactor2Collet1SetTemperature, iReactor2Collet1ActualTemperature, iReactor2Collet2On, iReactor2Collet2SetTemperature,
            iReactor2Collet2ActualTemperature, iReactor2Collet3On, iReactor2Collet3SetTemperature, iReactor2Collet3ActualTemperature, iReactor2StirMotor, iReactor2RaditationDetector,
            iReactor3SetPosition, iReactor3ActualPosition, iReactor3SetY, iReactor3ActualY, iReactor3RobotStatus, iReactor3RobotControl, iReactor3RobotCheck, iReactor3SetUp,
